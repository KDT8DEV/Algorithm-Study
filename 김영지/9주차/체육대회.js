 ...
 * 각 종목에 대한 학생들의 능력치가 아래 표와 같을 때, 각 종목의 대표를 뽑는 예시입니다.
 * 테니스 대표로 준모, 탁구 대표로 인용, 수영 대표로 정현을 뽑는다면, 세 명의 각 종목에 대한 능력치의 합은 200(=100+30+70)이 됩니다.
 * 하지만, 테니스 대표로 석환, 탁구 대표로 준모, 수영 대표로 정현을 뽑는다면 세 명의 각 종목에 대한 능력치 합은 210(=40+100+70)이 됩니다. 
...
//==============================연습장============================================//
// let ability = [[40, 10, 10], [20, 5, 0], [30, 30, 30], [70, 0, 70], [100, 100, 100]]; // 210
// // let ability = [[20, 30], [30, 20], [20, 30]]; // 60

// let a = [40, 20, 30, 70, 100];
// let b = [10, 5, 30, 0, 100];
// let c = [10, 0, 30, 70, 100];

// let maxArr = [];
// let maxIdx = [];
// ability.forEach(arr => {
//     maxArr.push(Math.max(...arr));
//     const mIdx = arr.reduce((acc, curr, idx, array) => {
//         return array[acc] < curr ? idx : acc 
//     },0);
//     console.log(mIdx);
//     // maxIdx.push(mIdx);
// })

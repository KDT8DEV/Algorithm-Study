...
function solution(food) {
  const printCnt = food.map((v, i) => Math.floor(v / 2));
  let str = "";
  for (let i = 1; i < food.length; i++) {
    str += i.toString().repeat(printCnt[i]);
  }
...
//==========================================//
// let food = [1, 7, 1, 2]; // "111303111"

// // 배열의 인덱스 = 음식의 종류 = 출력할 숫자
// // [0, 1, 2, 3]

// // 출력할 개수 = 각 요소를 2로 나눈 값 = Math.floor(food[i]/2)= k
// // 인덱스 0을 제외하고 0이 나올 경우 사용 안함
// // [0, 3, 0, 1]

// // 각 값의 인덱스를 1부터 k번 반복 후 reverse
// // i.repeat(k) = str
// // str + 0 + str.reverse
